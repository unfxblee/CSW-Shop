...
btn1.addEventListener("click", ()=>{
    ...
    art1.innerHTML = `Art 1 - $10 <button class="remove-item">Remove</button>`;
...
btn2.addEventListener("click", ()=>{
    ...
    art2.innerHTML = `Art 2 - $20 <button class="remove-item">Remove</button>`;
...
btn3.addEventListener("click", ()=>{
    ...
    art3.innerHTML = `Art 3 - $30 <button class="remove-item">Remove</button>`;
...
btn4.addEventListener("click", ()=>{
    ...
    art4.innerHTML = `Art 4 - $40 <button class="remove-item">Remove</button>`;
...
btn5.addEventListener("click", ()=>{
    ...
    art5.innerHTML = `Art 5 - $50 <button class="remove-item">Remove</button>`;
...
btn6.addEventListener("click", ()=>{
    ...
    art6.innerHTML = `Art 6 - $60 <button class="remove-item">Remove</button>`;
...
btn7.addEventListener("click", ()=>{
    ...
    art7.innerHTML = `Art 7 - $70 <button class="remove-item">Remove</button>`;
...
btn8.addEventListener("click", ()=>{
    ...
    art8.innerHTML = `Art 8 - $80 <button class="remove-item">Remove</button>`;
...
btn9.addEventListener("click", ()=>{
    ...
    art9.innerHTML = `Art 9 - $90 <button class="remove-item">Remove</button>`;
